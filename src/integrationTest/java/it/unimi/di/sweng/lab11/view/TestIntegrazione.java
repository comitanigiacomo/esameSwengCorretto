...
public class TestIntegrazione {
  ...
  @Test
  public void CommandView(FxRobot robot) {
    for (int i = 0; i < 8; i++){
      assertThat(display.get(i)).startsWith("");
      assertThat(display2.get(i)).startsWith("");
    }
  }

  @Test
  public void DisplayView(FxRobot robot) {
    for (int i = 0; i < 8; i++){
      assertThat(command[0].get(i)).startsWith("");
      assertThat(command[1].get(i)).startsWith("");
    }
  }
